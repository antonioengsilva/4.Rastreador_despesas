...
class ExpenseTracker(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Rastreador de despesas")

        self.db_file = "expenses.db"
        #self.db_file = "expenses.sqlite3"
    ...
    def delete_expense(self):
        ...
        if values:
            confirm = messagebox.askyesno(
                "Confirmar Exclusão", "Tem certeza de que deseja excluir esta despesa?")
            if confirm:
                conn = sqlite3.connect(self.db_file)
                c = conn.cursor()
                c.execute(
            ...
            messagebox.showwarning(
                "Aviso", "Selecione uma despesa para excluir.")
    ...
    def edit_expense(self):
        ...
        if values:
            ...
            messagebox.showwarning(
                "Aviso", "Selecione uma despesa para editar.")

    def create_context_menu(self):
        self.context_menu = tk.Menu(self, tearoff=0)
        self.context_menu.add_command(
            label="Deletar", command=self.delete_expense)
        self.context_menu.add_command(label="Alterar", command=self.edit_expense)
    ...
    def create_widgets(self):
        self.label_date = tk.Label(self, text="Data:")
        ...
        self.label_category = tk.Label(self, text="Categoria:")
        ...
        self.button_add_expense = tk.Button(
            self, text="Adionar Despesa", command=self.add_expense)
        self.button_add_expense.grid(row=3, columnspan=2, pady=10)

        self.button_visualize = tk.Button(
            self, text="Visualizar Dados", command=self.visualize_data)
        self.button_visualize.grid(row=6, columnspan=2, pady=10)

        self.button_visualize = tk.Button(
            self, text="Gerar Recibo", command=self.generate_receipt)
        ...
        self.tree_expenses.heading("Date", text="Data")
        self.tree_expenses.heading("Category", text="Categoria")
        self.tree_expenses.heading("Amount", text="Valor")
        ...
        self.label_total = tk.Label(
            self, text="Total Despesas: R$ 0.00", font=("Arial", 12))
    ...
    def add_expense(self):
        ...
        if date and category and amount:
            ...
            messagebox.showwarning("Aviso", "Por favor insira todos os campos.")
    ...
    def visualize_data(self):
        ...
        ax.set_title('Visualização de Despesas')
    ...
    def update_expenses(self):
        ...
        self.label_total.config(text=f"Total Despesas: R$ {total:.2f}")
    ...
    def generate_receipt(self):
        ...
        c.save()
        data = [['Data', 'Categoria', 'Quantidade']]
        ...
        messagebox.showinfo("Recibo Gerado",
                            f"Recibo salvo como {receipt_filename}")
